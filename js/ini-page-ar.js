// =============================================
//  init-page-ar.js - تهيئة الصفحة العربية
// =============================================

(function() {
  'use strict';
  
  console.log('🌍 [AR] تهيئة الصفحة العربية...');
  
  function ensureArabic() {
  ...
  function updateCounter() {
    ...
    if (display) {
      ...
      display.innerText = count.toLocaleString('ar-EG');
    }
    if (textEl) textEl.innerText = 'زوار';
  }
  
  function updateLangBtn() {
    const btn = document.getElementById('langBtn');
    if (btn) btn.textContent = '🇸🇦 عربي';
  }
